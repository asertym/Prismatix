...
<style>
	...
	.tooltip {
		&::after {
			@apply absolute max-w-40 rounded-lg border-inherit bg-inherit p-1 px-2 text-center text-sm text-nowrap text-inherit opacity-0 shadow-sm shadow-inherit transition-all select-none;
