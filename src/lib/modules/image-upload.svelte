	...
	>
		<div class="space-y-4">
			<div class="flex justify-center">
				<svg class="h-12 w-12 text-stone-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					<path
			...
			<div>
				<p class="text-lg font-medium text-stone-700">Drop images here</p>
				<p class="mt-1 text-sm text-stone-500">or click to browse, or paste from clipboard</p>
				<p class="mt-2 text-xs text-stone-400">Supported: .avif, .jpeg, .jpg, .jxl, .png, .webp</p>
			</div>
		</div>
	</div>
